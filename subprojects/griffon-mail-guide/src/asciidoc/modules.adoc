...
[[_modules]]
= Modules
:subproject-base: {rootdir}/subprojects/griffon-mail-
:java-source: /src/main/java/
:package-base: org/codehaus/griffon/runtime/mail
:numbered:
...
----
include::{subproject-base}core{java-source}{package-base}/MailModule.java[tags=bindings,indent=0]
----
